...
export const ModuleTextureBrowser = observer(() => {
    ...
    return (
        <div>
            <input value={textureId.toString(16)} onChange={e => setTextureId(parseInt(e.currentTarget.value, 16))} />

            {texture && texture.length > 0 && <TexturePreview texture={texture} type={TextureType.EightBitClut} />}
